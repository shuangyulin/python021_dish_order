...
class huiyuan(BaseModel):
    ...
    __loginUser__='huiyuanhao'


    __authTables__={}
    __authPeople__='是'#用户表，表属性loginUserColumn对应的值就是用户名字段，mima就是密码字段
    __loginUserColumn__='huiyuanhao'#用户表，表属性loginUserColumn对应的值就是用户名字段，mima就是密码字段
    ...
    huiyuanhao=models.CharField ( max_length=255,null=False,unique=True, verbose_name='会员号' )
...
class caipinleixing(BaseModel):
    __doc__ = u'''caipinleixing'''
    __tablename__ = 'caipinleixing'
    ...
    __isAdmin__='否'#表属性isAdmin=”是”,刷出来的用户表也是管理员，即page和list可以查看所有人的考试记录(同时应用于其他表)
    addtime = models.DateTimeField(auto_now_add=False, verbose_name=u'创建时间')
    caipinleixing=models.CharField ( max_length=255, null=True, unique=False, verbose_name='菜品类型' )
    '''
    caipinleixing=VARCHAR
    '''
    class Meta:
        db_table = 'caipinleixing'
        verbose_name = verbose_name_plural = '菜品类型'
class caipinxinxi(BaseModel):
    __doc__ = u'''caipinxinxi'''
    __tablename__ = 'caipinxinxi'
    ...
    __isAdmin__='否'#表属性isAdmin=”是”,刷出来的用户表也是管理员，即page和list可以查看所有人的考试记录(同时应用于其他表)
    addtime = models.DateTimeField(auto_now_add=False, verbose_name=u'创建时间')
    caipinmingcheng=models.CharField ( max_length=255,null=False, unique=False, verbose_name='菜品名称' )
    caipinleixing=models.CharField ( max_length=255,null=False, unique=False, verbose_name='菜品类型' )
    tupian=models.CharField ( max_length=255, null=True, unique=False, verbose_name='图片' )
    kouwei=models.CharField ( max_length=255, null=True, unique=False, verbose_name='口味' )
    yujishijian=models.CharField ( max_length=255,null=False, unique=False, verbose_name='预计时间' )
    caipinjieshao=models.TextField   (  null=True, unique=False, verbose_name='菜品介绍' )
    ...
    '''
    class Meta:
        db_table = 'caipinxinxi'
        verbose_name = verbose_name_plural = '菜品信息'
class cart(BaseModel):
    ...
    addtime = models.DateTimeField(auto_now_add=False, verbose_name=u'创建时间')
    tablename=models.CharField ( max_length=255, null=True, unique=False,default='caipinxinxi', verbose_name='商品表名' )
...
class discusscaipinxinxi(BaseModel):
    __doc__ = u'''discusscaipinxinxi'''
    __tablename__ = 'discusscaipinxinxi'
    ...
    '''
    class Meta:
        db_table = 'discusscaipinxinxi'
        verbose_name = verbose_name_plural = '菜品信息评论表'
